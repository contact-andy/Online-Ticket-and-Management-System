            ...
            <div class="card">
                <div class="card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Create Show</h3>
                        <div class="card-tools">
                            <a href="{{ route('admin.show.index') }}" class="btn btn-info btn-sm">Back</a>
                        </div>
                    </div>
                    <form class="needs-validation" novalidate action="{{ route('admin.show.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                            placeholder="Enter show name" required value="{{old('name')}}">
                                            </div>
                                <div class="row">
                                    <div class="col-6">
                                    ...
                                    placeholder="Enter production year" required value="">  
                                </div>
                            @error('name')
